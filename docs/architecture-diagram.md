...
flowchart LR
    ...
    Model["Model Service Adapter<br/>Future connection to Amazon Bedrock or another approved LLM provider"]
...
- **Retrieval Module:** Planned RAG boundary that retrieves relevant CMU support context before generation.
...
- **Model Service Adapter:** Planned boundary for calling a real model service without rewriting the API.
